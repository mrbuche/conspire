...
- [Mooney-Rivlin model](hyperelastic/mooney_rivlin.md)
- [Neo-Hookean model](hyperelastic/neo_hookean.md)
- [Saint-Venant Kirchhoff model](hyperelastic/saint_venant_kirchhoff.md)
